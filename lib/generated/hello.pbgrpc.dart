...
class HelloServiceClient extends $grpc.Client {
  ...
  static final _$lotsOfReplies = $grpc.ClientMethod<$0.HelloRequest, $0.HelloResponse>(
      '/hello.HelloService/LotsOfReplies',
      ($0.HelloRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.HelloResponse.fromBuffer(value));
  static final _$lotsOfGreetings = $grpc.ClientMethod<$0.HelloRequest, $0.HelloResponse>(
      '/hello.HelloService/LotsOfGreetings',
      ($0.HelloRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.HelloResponse.fromBuffer(value));
  static final _$bidiHello = $grpc.ClientMethod<$0.HelloRequest, $0.HelloResponse>(
  ...
  $grpc.ResponseStream<$0.HelloResponse> lotsOfReplies($0.HelloRequest request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$lotsOfReplies, $async.Stream.fromIterable([request]), options: options);
  }

  $grpc.ResponseFuture<$0.HelloResponse> lotsOfGreetings($async.Stream<$0.HelloRequest> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$lotsOfGreetings, request, options: options).single;
  }

  $grpc.ResponseStream<$0.HelloResponse> bidiHello($async.Stream<$0.HelloRequest> request, {$grpc.CallOptions? options}) {
...
abstract class HelloServiceBase extends $grpc.Service {
  ...
  $async.Stream<$0.HelloResponse> lotsOfReplies_Pre($grpc.ServiceCall $call, $async.Future<$0.HelloRequest> $request) async* {
    yield* lotsOfReplies($call, await $request);
  }

  $async.Future<$0.HelloResponse> sayHello($grpc.ServiceCall call, $0.HelloRequest request);
  $async.Stream<$0.HelloResponse> lotsOfReplies($grpc.ServiceCall call, $0.HelloRequest request);
  $async.Future<$0.HelloResponse> lotsOfGreetings($grpc.ServiceCall call, $async.Stream<$0.HelloRequest> request);
  $async.Stream<$0.HelloResponse> bidiHello($grpc.ServiceCall call, $async.Stream<$0.HelloRequest> request);
}
